...
export const PeriodosIdeais = (
    ...
    return(
        <>
          <Flex>
            <Text fontSize={"lg"} fontWeight={"normal"}>Se forma em <Span fontWeight={"normal"} color={EURECA_COLORS.AZUL_MEDIO} bg={`${EURECA_COLORS.AZUL_CLARO}/35`} p={1} rounded={"xs"}>{qtd} períodos</Span></Text>
