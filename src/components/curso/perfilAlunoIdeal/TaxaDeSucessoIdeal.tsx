...
export const TaxaDeSucessoIdeal = (
  ...
  return(
          <>
            <Flex>
              <Text mt={9} fontSize={"lg"} fontWeight={"normal"}>Possui taxa de sucesso de <Span fontWeight={"normal"} color={EURECA_COLORS.AZUL_MEDIO} bg={`${EURECA_COLORS.AZUL_CLARO}/35`} p={1} rounded={"xs"}>{porcentagem}%</Span></Text>
              <Icon>
